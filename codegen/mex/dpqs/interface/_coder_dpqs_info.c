 ...
 * _coder_dpqs_info.c
 *
 * Code generation for function '_coder_dpqs_info'
 *
 */
...
mxArray *emlrtMexFcnProperties(void)
{
  ...
  emlrtSetField(xEntryPoints, 0, "Name", mxCreateString("dpqs"));
...
/* End of code generation (_coder_dpqs_info.c) */
