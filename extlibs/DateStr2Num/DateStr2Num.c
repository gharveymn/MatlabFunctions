...
/*
% $JRev: R-m V:013 Sum:E1pTxUuGr2mQ Date:07-Dec-2014 18:50:03 $
...
double Str1031Num(const mxArray *S);
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray*prhs[])
{
   ...
   switch (Format) {
      ...
      case 1031:  CoreFcn = Str1031Num;  break;
...
{
  // Convert a single string to a serial date number.
  // "yyyy-mm-dd,HH:MM:SS.FFF"  "2000-03-01 15:45:17"
  ...
  if (mxGetNumberOfElements(S) < 19) {
      ERROR("BadDateString",
            "Bad string length for [yyyy-mm-dd HH:MM:SS.FFF] format.");
  }
