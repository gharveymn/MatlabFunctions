function [df, match, er1, er2] = compstruct_old(s1,s2,prt,pse,tol,n1,n2,wbf)
% check two structures for differances - i.e. see if strucutre s1 == structure s2
% function [match, er1, er2, erc, erv] = compstruct_old(s1,s2,prt,pse,tol,n1,n2,wbf)
%
% inputs  8 - 7 optional
...
%
% example:	[match, er1, er2] = compstruct_old(data1,data2,1,1,1e-6,'data1','data2')
...
if nargin < 1; help compstruct_old; error('I / O error'); end
